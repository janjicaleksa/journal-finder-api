...
class TfidfClassifier:
    ...
    def __init__(self, journal_descriptions: dict[str, str], ngram_range: tuple[int, int] = (1, 2), max_reasoning_terms: int = 5):
        ...
        self.vectorizer = TfidfVectorizer(lowercase=True, stop_words="english", ngram_range=ngram_range)
        self.journal_vectors = self.vectorizer.fit_transform(self.journal_texts)

    def classify(self, abstract: str) -> dict:
        """Classify a paper abstract and return the predicted journal category, all scores and the abstract vector.
        ...
        Returns a dict with keys:
            ...
            - abstract_vector: sparse TF-IDF vector of the abstract (used for reasoning).
        """
    ...
    def get_top_matching_terms(self, abstract_vector: np.ndarray, predicted_category: str) -> list[dict[str, float | str]]:
