...
class EmbeddingClassifier:
    ...
    def __init__(self, journal_descriptions: dict[str, str], embedding_model_name: str):
        ...
        self.journal_embeddings = self.model.encode(self.journal_texts, normalize_embeddings=True)
    ...
    def get_top_supporting_sentences(self, abstract: str, predicted_category: str, top_k: int = 2):
